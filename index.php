...
<head>
    ...
    <title>jquery data project</title>
    <!-- CSS only -->
...
<body>
    <div class="container">
        <div class="alert alert alert-success" role="alert">
            <h4 class="text-success text-center">Data project use jquery ajax and php</h4>
        </div>
        <div class="alert alert-info text-center message" role="alert">
        ...
        include_once 'tableProfile.php';

        ?>

        <div class="row" id='clientTable'></div>
